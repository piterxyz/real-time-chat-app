...
export default function FriendRequestNavigation({
    userId,
                ...
                <TooltipTrigger asChild>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <UserPlus />
                            {length > 0 && (
                                <p className="absolute -top-2 right-4 mr-2 flex h-3 w-3 items-center justify-center rounded-full bg-red-400 p-2 text-xs text-white">
                                    {length}
                                </p>
                            )}
                        </div>
